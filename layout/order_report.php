...
<body>
	<div class="box">
		<form name="form" method="GET" action="order_excel.php">
			...
			<?php
			$query1 = mysqli_query($conn, "SELECT * FROM `order_tbl`"); 
			?>
			<div class="form-group">
				<label></label><br>
				<button style="margin-top:30px;" type="submit" name="gene" class="btns">Generate</button>
			</div>
