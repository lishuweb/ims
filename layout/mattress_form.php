...
<body>
        ...
        <div class="opt">
            <a href="mattress_form.php">Insert</a>
            <a href="mattress_table.php">Delete</a>
            <a href="mattress_table.php">Update</a>
            <a href="mattress_table.php">View</a>
        </div>

		<div class="forms">

			<div class="hd">
				<h1><i class="fa-solid fa-mattress-pillow"></i>Mattress</h1>	
			</div>

            <form action="mattress_insert.php" method="post" enctype="multipart/form-data">
               
                <div class="form-outline">
                    <label class="form-label" for="form1Example1">Title</label><br>
                    <input type="text" name="m_title" class="form-control" required="" />
                </div>
                ...
                <div class="custom-select">
                    ...
                    <div class="select-style">
                        <select name="m_type" required="" id="try" onchange="changevalu();">
                ...
                <div class="form-outline">
                    ...
                    <input type="text" name="m_size" id="getValue" readonly>
                </div>

                <div class="form-outline">
                    <label class="form-label" for="form1Example1">Item Weight</label><br>
                    <input type="text" name="m_weight" id="getWeight" readonly>
                    <script type="text/javascript">
                       function changevalu()
                       {
                         ...
                         if(v == "Foam")
                         {
                            document.getElementById('getValue').value = "5 x 6.5";
                            document.getElementById('getWeight').value = "200";
                        }
                        else if(v == "Spring")
                        {
                            document.getElementById('getValue').value = "6 x 5";
                            document.getElementById('getWeight').value = "300";

                        }
                        else
                        {
                            document.getElementById('getValue').value = "7 x 8";
                            document.getElementById('getWeight').value = "380";
                        }
                    }
                    </script>
                </div>
                ...
                <div class="form-outline">
                    ...
                    <input type="text" name="m_stock" class="form-control" required="" />
                </div>
