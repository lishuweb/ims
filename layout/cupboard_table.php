            ...
            <div class="down">
                <table>
                    ...
                    <?php 
                        ...
                        $select_result = mysqli_query($conn,"SELECT * from cupboard_tbl Order by id Desc");
                            ...
                            <?php 
                                while($row=mysqli_fetch_assoc($select_result))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="delete_cupboard.php?a_id=<?php echo $row['id'];?>" value="Delete" title="Delete" onclick="return confirm('Are you sure you want to delete this Data?');"><input type="button" name="delete" value="Delete"><i class="fa-solid fa-trash"></i></a>

                                            <a href="update_cupboard_form.php?a_id=<?php echo $row['id'];?>" title="Edit" ><input type="button" name="editabout" value="Edit"><i class="fa-solid fa-wrench"></i></a>
                                        </td>
